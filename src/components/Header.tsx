      ...
      <div className="max-w-5xl px-2 sm:px-0 mx-auto">
        <div className="flex justify-between items-center h-16">
          ...
          <button 
            ...
            className="border-2 rounded-full px-6 py-2 font-medium border-black flex items-center transition-all duration-300 hover:bg-black hover:text-white hover:shadow-lg hover:scale-102 group hover:cursor-pointer"
          >
            Get Early Access
